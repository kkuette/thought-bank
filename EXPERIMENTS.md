...
| v3_deep (depth 2) | is the depth flag neutral when unused? | 🟡 job 100 in flight | — |
...
| reach-back SFT (option 2, next) | can the page read be *created* like addressing was? | 🟡 design phase — stratified by eviction age (user reservation: deepest-block targets may not learn → per-stratum loss is the sub-verdict) | — |
