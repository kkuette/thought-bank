...
| B1 trained taper (v2e_md256) (FINDINGS 2026-07-13 (5)) | does training close the 512→256 gap? | ✅ carried Δ −0.014 code / +0.042 web @800 (grid ±0.15) → trained taper 512→256 is FREE; 350M VRAM budgets with 512/256/128 stand | init v2b_md256_s4 vs v2c (equal post-init budget, seed noise uncontrolled); md128 arm now promotable |
